<template>
    <div class="joinus">
      ...
      <h1>履修希望の方へ</h1>
      <p>履修希望の方は、以下の内容を確認の上、履修希望のメールを<a href="mailto:d-hacks-group@keio.jp">d-hacks-group@keio.jp</a>まで送信してください。</p>
      ...
      <p>
        <ul>
          ...
          <li>高校で数学II・Bまではとっていること（または同等の知識を有していること）</li>
          <li>研究会の講義と、d-hacksのミーティングに出席できること（既に授業を入れてしまっている場合はご相談ください。）</li>
        </ul>
      </p>
