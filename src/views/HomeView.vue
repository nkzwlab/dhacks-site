    ...
    <div class="home__about">
      ...
      <div class="home__about__description-container">
        <div class="home__about__description">
          私たちは、最新の人工知能技術を実際の問題を解決する際の実用的なアプローチとして使用し、より豊かな社会の実現を目指している中澤・大越研究室に属する研究グループです。複雑なパターンや現象のモデリングを可能にする深層学習をはじめとした機械学習技術を用いた、都市や家庭向けのシステムの研究・開発に取り組んでいます。
        </div>
        <div class="home__about__description">
